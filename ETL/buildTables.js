...
pool.query('DROP TABLE characteristics_average')
    .then(() => {
        pool.query('CREATE TABLE characteristic_average (id serial NOT NULL, characteristic_id int, average int, PRIMARY KEY(id))')
    })
